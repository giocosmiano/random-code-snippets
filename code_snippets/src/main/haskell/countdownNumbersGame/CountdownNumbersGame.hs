...
-- https://www.youtube.com/watch?v=a0fPHkzK36I&list=PLF1Z-APd9zK7usPMx3LGMZEHrECUGodd3
...
-----------------------------------------------------------------------------------
-- $ stack ghci
-- Prelude> :l CountdownNumbersGame
--
-- OR compiling via stack --> https://docs.haskellstack.org/en/stable/GUIDE/#ghcrunghc
-- $ stack ghc CountdownNumbersGame.hs
--
-- ./CountdownNumbersGame
-- Enter the given numbers : [1,2,3,4,5]
-- Enter the target number : 100
-- One possible solution is (2+3)*(4*5), found in 0.001 seconds
...
-- 4*(5*((2*3)-1))
-- 5*(4*((2*3)-1))
-- There were 8 solutions in total, found in 0.009 seconds.
--
