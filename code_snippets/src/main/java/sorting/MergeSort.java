...
public class MergeSort {
  ...
  */
  ...
  public static void main(String[] args) {
    ...
    watch.start();
    boolean isBigArraySorted = mergeSort(unSorted).equals(sorted);
    watch.stop();
    System.out.println("Time Elapsed: " + watch.getTime() / 1000.0 + " secs");
    System.out.printf("isBigArraySorted using `mergeSort` with %s elements --> %s", unSorted.size(), isBigArraySorted);
  }
}